  ...
  const onDrop = useCallback((acceptedFiles: File[]) => {
    ...
    if (imageFiles.length > 0) {
      ...
      toast({
        ...
        description: `${imageFiles.length} images added for conversion.`,
      });
    } else {
      toast({
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Convert multiple JPG images into a single PDF document with high quality output.
          </p>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2">
                  {isDragActive ? "Drop your JPG files here" : "Upload JPG Files"}
                </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
            ...
            <p className="text-gray-400">
              Upload multiple JPG files and combine them into a single PDF.
            </p>
          </div>
