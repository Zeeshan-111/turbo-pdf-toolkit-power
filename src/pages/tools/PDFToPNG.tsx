  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `Successfully converted ${convertedImages.length} pages to PNG format.`,
      });
    } catch (error) {
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
            ...
            <div className="text-center space-y-6">
              {!isConverting && images.length === 0 && !error && (
                <Button
                  ...
                  size="lg"
                  className="bg-gradient-to-r from-green-500 to-teal-500 hover:from-green-600 hover:to-teal-600 text-white px-8 py-3 text-lg"
                >
                  Convert to PNG
                </Button>
              )}
                  ...
                  <div className="flex items-center justify-center space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300">
                        {images.length} pages converted to PNG
                      </p>
                    </div>
                  </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
            ...
            <h3 className="text-lg font-semibold mb-2">High Quality PNG</h3>
            <p className="text-gray-400">
              Convert PDF pages to high-resolution PNG images with transparency support.
            </p>
          </div>
          ...
          <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
            ...
            <p className="text-gray-400">
              Each PDF page is converted to a separate PNG image file.
            </p>
          </div>
